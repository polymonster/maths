...
{
    {
        ...
        REQUIRE(require_func(result,vec3f(-284.988, 203.427, -1.94213)));
    }
    {
        //ray_plane_intersect---------------------------
        ...
        vec3f result = ray_plane_intersect(r0, rV, x0, xN);
        REQUIRE(require_func(result,vec3f(-4.32493, -5.76715, 8.19684)));
    }
    {
        //ray_plane_intersect---------------------------
        ...
        vec3f result = ray_plane_intersect(r0, rV, x0, xN);
        REQUIRE(require_func(result,vec3f(6.28316, -19.3044, 17.8625)));
    }
    {
        //ray_plane_intersect---------------------------
        ...
        vec3f result = ray_plane_intersect(r0, rV, x0, xN);
        REQUIRE(require_func(result,vec3f(-6.2329, 2.47297, 9.25753)));
    }
    {
        //ray_plane_intersect---------------------------
        ...
        vec3f result = ray_plane_intersect(r0, rV, x0, xN);
        REQUIRE(require_func(result,vec3f(30.3597, 16.5864, -9.47733)));
    }
    {
        //ray_plane_intersect---------------------------
        ...
        vec3f result = ray_plane_intersect(r0, rV, x0, xN);
        REQUIRE(require_func(result,vec3f(2.82605, -4.01052, 0.341848)));
    }
    {
        //ray_plane_intersect---------------------------
        ...
        vec3f result = ray_plane_intersect(r0, rV, x0, xN);
        REQUIRE(require_func(result,vec3f(-3.72752, 9.11604, 5.69883)));
    }
    {
        //ray_plane_intersect---------------------------
        ...
        vec3f result = ray_plane_intersect(r0, rV, x0, xN);
        REQUIRE(require_func(result,vec3f(1.15085, 1.50882, 5.35161)));
    }
    {
        //ray_plane_intersect---------------------------
        ...
        vec3f result = ray_plane_intersect(r0, rV, x0, xN);
        REQUIRE(require_func(result,vec3f(-12.4664, 17.3897, -7.97657)));
    }
    {
        //ray_plane_intersect---------------------------
        ...
        vec3f result = ray_plane_intersect(r0, rV, x0, xN);
        REQUIRE(require_func(result,vec3f(-40.209, 32.0774, 19.79)));
    }
}
...
TEST_CASE( "Point Inside AABB / Closest Point on AABB", "[maths]")
{
    ...
    }
    {
        ...
        REQUIRE(require_func(result,vec3f(-5.07, 7.2, -8.84)));
    }
    {
        //point_inside_aabb---------------------------
    ...
    }
    {
        ...
        vec3f result = closest_point_on_aabb(s0, aabb_min, aabb_max);
        REQUIRE(require_func(result,vec3f(5.19, -3.84, 2.53)));
    }
    {
        //point_inside_aabb---------------------------
    ...
    }
    {
        ...
        vec3f result = closest_point_on_aabb(s0, aabb_min, aabb_max);
        REQUIRE(require_func(result,vec3f(-7.6, 6.83, -2.09)));
    }
    {
        //point_inside_aabb---------------------------
    ...
    }
    {
        ...
        vec3f result = closest_point_on_aabb(s0, aabb_min, aabb_max);
        REQUIRE(require_func(result,vec3f(7.27, 8.27, 1.78)));
    }
    {
        //point_inside_aabb---------------------------
    ...
    }
    {
        ...
        vec3f result = closest_point_on_aabb(s0, aabb_min, aabb_max);
        REQUIRE(require_func(result,vec3f(5.25, 0.97, 4.4)));
    }
    {
        //point_inside_aabb---------------------------
    ...
    }
    {
        ...
        vec3f result = closest_point_on_aabb(s0, aabb_min, aabb_max);
        REQUIRE(require_func(result,vec3f(1.67, 0.43, -8.77)));
    }
    {
        //point_inside_aabb---------------------------
    ...
    }
    {
        ...
        vec3f result = closest_point_on_aabb(s0, aabb_min, aabb_max);
        REQUIRE(require_func(result,vec3f(8.27, 6.12, -2.72)));
    }
    {
        //point_inside_aabb---------------------------
    ...
    }
    {
        ...
        vec3f result = closest_point_on_aabb(s0, aabb_min, aabb_max);
        REQUIRE(require_func(result,vec3f(5.76, -3.34, 1.21)));
    }
    {
        //point_inside_aabb---------------------------
    ...
    }
    {
        ...
        vec3f result = closest_point_on_aabb(s0, aabb_min, aabb_max);
        REQUIRE(require_func(result,vec3f(-2.7, 5.18, 7.18)));
    }
    {
        //point_inside_aabb---------------------------
    ...
    }
    {
        ...
        vec3f result = closest_point_on_aabb(s0, aabb_min, aabb_max);
        REQUIRE(require_func(result,vec3f(8.25, -0.82, -2.47)));
    }
}
...
{
    {
        ...
        REQUIRE(require_func(result,vec3f(-6.04, -0.65, 0.83)));
    }
    {
    ...
    }
    {
        ...
        vec3f result = closest_point_on_line(l1, l2, p);
        REQUIRE(require_func(result,vec3f(-0.915376, -4.87087, -7.88041)));
    }
    {
        //point_segment_distance---------------------------
    ...
    }
    {
        ...
        vec3f result = closest_point_on_line(l1, l2, p);
        REQUIRE(require_func(result,vec3f(6.93, 5.79, 1.29)));
    }
    {
        //point_segment_distance---------------------------
    ...
    }
    {
        ...
        vec3f result = closest_point_on_line(l1, l2, p);
        REQUIRE(require_func(result,vec3f(6.7, 2.17, -1.54)));
    }
    {
        //point_segment_distance---------------------------
    ...
    }
    {
        ...
        vec3f result = closest_point_on_line(l1, l2, p);
        REQUIRE(require_func(result,vec3f(2.35, 9.12, 6.84)));
    }
    {
        //point_segment_distance---------------------------
    ...
    }
    {
        ...
        vec3f result = closest_point_on_line(l1, l2, p);
        REQUIRE(require_func(result,vec3f(4.50341, 3.74744, 1.65078)));
    }
    {
        //point_segment_distance---------------------------
    ...
    }
    {
        ...
        vec3f result = closest_point_on_line(l1, l2, p);
        REQUIRE(require_func(result,vec3f(-3.21, -2.35, 3.91)));
    }
    {
        //point_segment_distance---------------------------
    ...
    }
    {
        ...
        vec3f result = closest_point_on_line(l1, l2, p);
        REQUIRE(require_func(result,vec3f(1.50571, -8.49464, 6.84866)));
    }
    {
        //point_segment_distance---------------------------
    ...
    }
    {
        ...
        vec3f result = closest_point_on_line(l1, l2, p);
        REQUIRE(require_func(result,vec3f(3.50592, -6.15411, -2.56341)));
    }
    {
        //point_segment_distance---------------------------
    ...
    }
    {
        ...
        vec3f result = closest_point_on_line(l1, l2, p);
        REQUIRE(require_func(result,vec3f(-4.43, -0.04, -0.45)));
    }
    {
        //point_segment_distance---------------------------
...
{
    {
        ...
        REQUIRE(require_func(result,vec3f(-0.500472, -10.5488, 1.41162)));
    }
    {
        //closest_point_on_ray---------------------------
        ...
        vec3f result = closest_point_on_ray(r0, rV, p);
        REQUIRE(require_func(result,vec3f(5.49715, 1.20032, 11.1349)));
    }
    {
        //closest_point_on_ray---------------------------
        ...
        vec3f result = closest_point_on_ray(r0, rV, p);
        REQUIRE(require_func(result,vec3f(4.84623, -1.10585, -7.77604)));
    }
    {
        //closest_point_on_ray---------------------------
        ...
        vec3f result = closest_point_on_ray(r0, rV, p);
        REQUIRE(require_func(result,vec3f(4.71062, -2.90679, 7.05979)));
    }
    {
        //closest_point_on_ray---------------------------
        ...
        vec3f result = closest_point_on_ray(r0, rV, p);
        REQUIRE(require_func(result,vec3f(-7.45603, 5.55689, -7.57615)));
    }
    {
        //closest_point_on_ray---------------------------
        ...
        vec3f result = closest_point_on_ray(r0, rV, p);
        REQUIRE(require_func(result,vec3f(-4.06919, -1.6345, -4.0352)));
    }
    {
        //closest_point_on_ray---------------------------
        ...
        vec3f result = closest_point_on_ray(r0, rV, p);
        REQUIRE(require_func(result,vec3f(-8.42053, 8.26807, -4.06158)));
    }
    {
        //closest_point_on_ray---------------------------
        ...
        vec3f result = closest_point_on_ray(r0, rV, p);
        REQUIRE(require_func(result,vec3f(0.255505, 12.9922, 5.39282)));
    }
    {
        //closest_point_on_ray---------------------------
        ...
        vec3f result = closest_point_on_ray(r0, rV, p);
        REQUIRE(require_func(result,vec3f(-6.67037, -0.0679825, 2.09578)));
    }
    {
        //closest_point_on_ray---------------------------
        ...
        vec3f result = closest_point_on_ray(r0, rV, p);
        REQUIRE(require_func(result,vec3f(-5.58153, -10.4517, -2.44792)));
    }
}
TEST_CASE( "Point Inside Triangle / Point Triangle Distance / Closest Point on Triangle / Get Normal", "[maths]")
{
    ...
    }
    {
        ...
        REQUIRE(require_func(result,vec3f(0, -1, 0)));
    }
    {
        ...
        REQUIRE(require_func(result,vec3f(7.81647, 0, 6.86698)));
    ...
    }
    {
        ...
        f32 side = { 0 };
        vec3f result = closest_point_on_triangle(p, v1, v2, v3, side);
        REQUIRE(require_func(result,vec3f(-0.376334, 0, -3.34522)));
        REQUIRE(require_func(side,{-1}));
    }
    {
        //point_inside_triangle---------------------------
    ...
    }
    {
        ...
        f32 side = { 0 };
        vec3f result = closest_point_on_triangle(p, v1, v2, v3, side);
        REQUIRE(require_func(result,vec3f(2.5, 0, -2.65)));
        REQUIRE(require_func(side,{-1}));
    }
    {
        //point_inside_triangle---------------------------
    ...
    }
    {
        ...
        f32 side = { 0 };
        vec3f result = closest_point_on_triangle(p, v1, v2, v3, side);
        REQUIRE(require_func(result,vec3f(-2.86, 0, 4.2)));
        REQUIRE(require_func(side,{-1}));
    }
    {
        //point_inside_triangle---------------------------
    ...
    }
    {
        ...
        f32 side = { 0 };
        vec3f result = closest_point_on_triangle(p, v1, v2, v3, side);
        REQUIRE(require_func(result,vec3f(-4.16131, 0, 1.4275)));
        REQUIRE(require_func(side,{-1}));
    }
    {
        //point_inside_triangle---------------------------
    ...
    }
    {
        ...
        f32 side = { 0 };
        vec3f result = closest_point_on_triangle(p, v1, v2, v3, side);
        REQUIRE(require_func(result,vec3f(7.08692, 0, 1.22464)));
        REQUIRE(require_func(side,{-1}));
    }
    {
        //point_inside_triangle---------------------------
    ...
    }
    {
        ...
        f32 side = { 0 };
        vec3f result = closest_point_on_triangle(p, v1, v2, v3, side);
        REQUIRE(require_func(result,vec3f(-1.66749, 0, -8.72078)));
        REQUIRE(require_func(side,{-1}));
    }
    {
        //point_inside_triangle---------------------------
    ...
    }
    {
        ...
        f32 side = { 0 };
        vec3f result = closest_point_on_triangle(p, v1, v2, v3, side);
        REQUIRE(require_func(result,vec3f(-2.58917, 0, -1.66179)));
        REQUIRE(require_func(side,{-1}));
    }
    {
        //point_inside_triangle---------------------------
    ...
    }
    {
        ...
        f32 side = { 0 };
        vec3f result = closest_point_on_triangle(p, v1, v2, v3, side);
        REQUIRE(require_func(result,vec3f(-0.886045, 0, -0.611142)));
        REQUIRE(require_func(side,{-1}));
    }
    {
        //point_inside_triangle---------------------------
    ...
    }
    {
        ...
        f32 side = { 0 };
        vec3f result = closest_point_on_triangle(p, v1, v2, v3, side);
        REQUIRE(require_func(result,vec3f(-3.9, 0, -1.51)));
        REQUIRE(require_func(side,{-1}));
    }
}
...
TEST_CASE( "Point inside Sphere", "[maths]")
{
    ...
    }
    {
        ...
        REQUIRE(require_func(result,vec3f(0.717249, 3.29966, 1.36513)));
    }
    {
        //point_inside_sphere---------------------------
    ...
    }
    {
        ...
        const vec3f p0 = {-8.71, 2.88, 8.48};
        vec3f result = closest_point_on_sphere(s0, r0, p0);
        REQUIRE(require_func(result,vec3f(8.18747, 5.05522, -0.606469)));
    }
    {
        //point_inside_sphere---------------------------
    ...
    }
    {
        ...
        const vec3f p0 = {-0.74, 9.68, 8.06};
        vec3f result = closest_point_on_sphere(s0, r0, p0);
        REQUIRE(require_func(result,vec3f(1.60078, 6.46979, 8.66191)));
    }
    {
        //point_inside_sphere---------------------------
    ...
    }
    {
        ...
        const vec3f p0 = {-1.81, 8.64, 1.37};
        vec3f result = closest_point_on_sphere(s0, r0, p0);
        REQUIRE(require_func(result,vec3f(-2.63058, -0.205356, 1.26743)));
    }
    {
        //point_inside_sphere---------------------------
    ...
    }
    {
        ...
        const vec3f p0 = {7.48, 9.61, 6.51};
        vec3f result = closest_point_on_sphere(s0, r0, p0);
        REQUIRE(require_func(result,vec3f(-3.2845, 4.82688, -7.58189)));
    }
    {
        //point_inside_sphere---------------------------
    ...
    }
    {
        ...
        const vec3f p0 = {0.63, 2.35, 5.06};
        vec3f result = closest_point_on_sphere(s0, r0, p0);
        REQUIRE(require_func(result,vec3f(-5.79199, 2.94866, 6.22331)));
    }
    {
        //point_inside_sphere---------------------------
    ...
    }
    {
        ...
        const vec3f p0 = {3.92, -0.47, -0.22};
        vec3f result = closest_point_on_sphere(s0, r0, p0);
        REQUIRE(require_func(result,vec3f(1.35574, -2.56447, -0.264742)));
    }
    {
        //point_inside_sphere---------------------------
    ...
    }
    {
        ...
        const vec3f p0 = {-9.68, -1.81, 5.31};
        vec3f result = closest_point_on_sphere(s0, r0, p0);
        REQUIRE(require_func(result,vec3f(-10.3646, -1.11709, 5.61915)));
    }
    {
        //point_inside_sphere---------------------------
    ...
    }
    {
        ...
        const vec3f p0 = {-2.22, -7.35, 0.45};
        vec3f result = closest_point_on_sphere(s0, r0, p0);
        REQUIRE(require_func(result,vec3f(-2.89957, 0.849606, 0.390258)));
    }
    {
        //point_inside_sphere---------------------------
    ...
    }
    {
        ...
        const vec3f p0 = {7.66, -4.66, 0.83};
        vec3f result = closest_point_on_sphere(s0, r0, p0);
        REQUIRE(require_func(result,vec3f(-5.71159, 2.52411, 5.6554)));
    }
}
TEST_CASE( "Ray vs AABB", "[maths]")
{
    ...
    }
    {
        ...
        bool result = ray_vs_aabb(emin, emax, r1, rv, ip);
        REQUIRE(require_func(result,bool(1)));
        REQUIRE(require_func(ip,{-7.30364, -7.98, -0.977728}));
    }
    {
        //ray_vs_aabb---------------------------
...
{
    {
        ...
        REQUIRE(require_func(result,bool(0)));
        REQUIRE(require_func(ip,{-8.14, 0.96, 6.85}));
    }
    {
        //closest_point_on_ray---------------------------
        ...
        const vec3f p = {0, 0, 0};
        vec3f result = closest_point_on_ray(r0, rV, p);
        REQUIRE(require_func(result,vec3f(19.1448, -4.87492, 16.2489)));
    }
    {
        //ray_vs_obb---------------------------
        ...
        bool result = ray_vs_obb(mat, r1, rv, ip);
        REQUIRE(require_func(result,bool(0)));
        REQUIRE(require_func(ip,{-9.69, -1.7, -9.05}));
    }
    {
        //closest_point_on_ray---------------------------
        ...
        const vec3f p = {0, 0, 0};
        vec3f result = closest_point_on_ray(r0, rV, p);
        REQUIRE(require_func(result,vec3f(-1.38283, 0.654136, -0.849645)));
    }
    {
        //ray_vs_obb---------------------------
        ...
        bool result = ray_vs_obb(mat, r1, rv, ip);
        REQUIRE(require_func(result,bool(1)));
        REQUIRE(require_func(ip,{-0.715326, -7.26692, 5.37811}));
    }
    {
        //closest_point_on_ray---------------------------
        ...
        const vec3f p = {0, 0, 0};
        vec3f result = closest_point_on_ray(r0, rV, p);
        REQUIRE(require_func(result,vec3f(-0.379437, 0.0961331, 0.0880504)));
    }
    {
        //ray_vs_obb---------------------------
        ...
        bool result = ray_vs_obb(mat, r1, rv, ip);
        REQUIRE(require_func(result,bool(0)));
        REQUIRE(require_func(ip,{-0.0600004, 9.45, -3.98}));
    }
    {
        //closest_point_on_ray---------------------------
        ...
        const vec3f p = {0, 0, 0};
        vec3f result = closest_point_on_ray(r0, rV, p);
        REQUIRE(require_func(result,vec3f(1.31596, 0.613271, -2.69128)));
    }
    {
        //ray_vs_obb---------------------------
        ...
        bool result = ray_vs_obb(mat, r1, rv, ip);
        REQUIRE(require_func(result,bool(0)));
        REQUIRE(require_func(ip,{-7.99, -4.58, 9.44}));
    }
    {
        //closest_point_on_ray---------------------------
        ...
        const vec3f p = {0, 0, 0};
        vec3f result = closest_point_on_ray(r0, rV, p);
        REQUIRE(require_func(result,vec3f(-1.4883, -1.43941, -0.107405)));
    }
    {
        //ray_vs_obb---------------------------
        ...
        bool result = ray_vs_obb(mat, r1, rv, ip);
        REQUIRE(require_func(result,bool(1)));
        REQUIRE(require_func(ip,{-6.05748, -3.74825, 7.03685}));
    }
    {
        //closest_point_on_ray---------------------------
        ...
        const vec3f p = {0, 0, 0};
        vec3f result = closest_point_on_ray(r0, rV, p);
        REQUIRE(require_func(result,vec3f(0.875358, -0.670723, 0.329894)));
    }
    {
        //ray_vs_obb---------------------------
        ...
        bool result = ray_vs_obb(mat, r1, rv, ip);
        REQUIRE(require_func(result,bool(0)));
        REQUIRE(require_func(ip,{-2.39, -1.36, 4.05}));
    }
    {
        //closest_point_on_ray---------------------------
        ...
        const vec3f p = {0, 0, 0};
        vec3f result = closest_point_on_ray(r0, rV, p);
        REQUIRE(require_func(result,vec3f(-4.54196, 3.10898, -0.0527496)));
    }
    {
        //ray_vs_obb---------------------------
        ...
        bool result = ray_vs_obb(mat, r1, rv, ip);
        REQUIRE(require_func(result,bool(0)));
        REQUIRE(require_func(ip,{-7.81, -7.88, 3.17}));
    }
    {
        //closest_point_on_ray---------------------------
        ...
        const vec3f p = {0, 0, 0};
        vec3f result = closest_point_on_ray(r0, rV, p);
        REQUIRE(require_func(result,vec3f(-1.54772, 0.0851345, -0.282768)));
    }
    {
        //ray_vs_obb---------------------------
        ...
        bool result = ray_vs_obb(mat, r1, rv, ip);
        REQUIRE(require_func(result,bool(1)));
        REQUIRE(require_func(ip,{-4.31475, -7.60153, 0.347639}));
    }
    {
        //closest_point_on_ray---------------------------
        ...
        const vec3f p = {0, 0, 0};
        vec3f result = closest_point_on_ray(r0, rV, p);
        REQUIRE(require_func(result,vec3f(-0.42003, -0.632512, -0.962511)));
    }
    {
        //ray_vs_obb---------------------------
        ...
        bool result = ray_vs_obb(mat, r1, rv, ip);
        REQUIRE(require_func(result,bool(0)));
        REQUIRE(require_func(ip,{9.16, 5.84, 8.69}));
    }
    {
        //closest_point_on_ray---------------------------
        ...
        const vec3f p = {0, 0, 0};
        vec3f result = closest_point_on_ray(r0, rV, p);
        REQUIRE(require_func(result,vec3f(-0.0101026, 2.67411, -3.3287)));
    }
}
TEST_CASE( "Line vs Line", "[maths]")
{
    ...
    }
    {
        ...
        bool result = line_vs_line(l1, l2, s1, s2, ip);
        REQUIRE(require_func(result,bool(1)));
        REQUIRE(require_func(ip,{-2.71285, 0, -2.70898}));
    }
    {
        //line_vs_line---------------------------
    ...
    }
    {
        ...
        bool result = line_vs_line(l1, l2, s1, s2, ip);
        REQUIRE(require_func(result,bool(0)));
        REQUIRE(require_func(ip,{7.29539, 0, 6.0172}));
    }
    {
        //line_vs_line---------------------------
    ...
    }
    {
        ...
        bool result = line_vs_line(l1, l2, s1, s2, ip);
        REQUIRE(require_func(result,bool(1)));
        REQUIRE(require_func(ip,{3.00521, 0, -2.45497}));
    }
    {
        //line_vs_line---------------------------
        ...
        bool result = line_vs_line(l1, l2, s1, s2, ip);
        REQUIRE(require_func(result,bool(0)));
        REQUIRE(require_func(ip,{-7.19655, 0, -5.82361}));
    }
    {
        //line_vs_line---------------------------
...
TEST_CASE( "Point Inside OBB / Closest Point on OBB", "[maths]")
{
    ...
    }
    {
        ...
        REQUIRE(require_func(result,vec3f(-1.95256, -8.6304, -3.97339)));
    }
    {
        //point_inside_obb---------------------------
    ...
    }
    {
        ...
        const vec3f p = {8.63, 4.16, -3.2};
        vec3f result = closest_point_on_obb(mat, p);
        REQUIRE(require_func(result,vec3f(1.67006, 2.96691, -1.68439)));
    }
    {
        //point_inside_obb---------------------------
    ...
    }
    {
        ...
        const vec3f p = {6.14, 7.15, 3.08};
        vec3f result = closest_point_on_obb(mat, p);
        REQUIRE(require_func(result,vec3f(4.9101, 2.27943, 1.28843)));
    }
    {
        //point_inside_obb---------------------------
    ...
    }
    {
        ...
        const vec3f p = {5.18, -1.47, -4.21};
        vec3f result = closest_point_on_obb(mat, p);
        REQUIRE(require_func(result,vec3f(4.8848, 5.08166, 3.78453)));
    }
    {
        //point_inside_obb---------------------------
    ...
    }
    {
        ...
        const vec3f p = {4.36, 2.79, -0.85};
        vec3f result = closest_point_on_obb(mat, p);
        REQUIRE(require_func(result,vec3f(-4.76926, 1.79969, -1.04446)));
    }
    {
        //point_inside_obb---------------------------
    ...
    }
    {
        ...
        const vec3f p = {-2.94, -8.22, -6.94};
        vec3f result = closest_point_on_obb(mat, p);
        REQUIRE(require_func(result,vec3f(-0.00442815, -0.597464, -2.26316)));
    }
    {
        //point_inside_obb---------------------------
    ...
    }
    {
        ...
        const vec3f p = {6.63, 6.37, 8.98};
        vec3f result = closest_point_on_obb(mat, p);
        REQUIRE(require_func(result,vec3f(-3.87011, -7.02621, 15.1744)));
    }
    {
        //point_inside_obb---------------------------
    ...
    }
    {
        ...
        const vec3f p = {-9.27, 9.62, -0.21};
        vec3f result = closest_point_on_obb(mat, p);
        REQUIRE(require_func(result,vec3f(7.10027, 0.262104, -1.7715)));
    }
    {
        //point_inside_obb---------------------------
    ...
    }
    {
        ...
        const vec3f p = {5.97, 4.24, -1.29};
        vec3f result = closest_point_on_obb(mat, p);
        REQUIRE(require_func(result,vec3f(-3.47628, -2.5305, -0.315799)));
    }
    {
        //point_inside_obb---------------------------
    ...
    }
    {
        ...
        const vec3f p = {3.56, 9.4, -4.06};
        vec3f result = closest_point_on_obb(mat, p);
        REQUIRE(require_func(result,vec3f(2.72863, 7.82304, -3.92447)));
    }
}
